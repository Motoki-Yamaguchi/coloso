...
add_filter(
	'template_include',
	function ( $template ) {
		// Use front page or home template for page shown on front instead of page template.
		if ( is_front_page() && is_page() ) {
			$template = get_front_page_template() ?: get_home_template();
		}

		// Use archive template for blog page instead of home template.
		if ( is_home() && ! is_front_page() ) {
			$template = get_archive_template() ?: get_home_template();
		}
